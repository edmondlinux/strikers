...
import { ArrowLeft, Heart, Calendar, Settings, Gauge, Users, Fuel, Zap } from "lucide-react";
                                        ...
                                        >
                                                ...
                                                <div className='space-y-3'>
                                                        <button
                                                                ...
                                                                className='w-full flex items-center justify-center space-x-2 bg-red-600 hover:bg-red-700 text-white font-semibold py-3 px-6 rounded-lg transition duration-300'
                                                        >
                                                                <span>Buy Now</span>
                                                        </button>
                                                        ...
                                                        <div className='flex space-x-3'>
                                                                <button
                                                                        ...
                                                                        className='flex-1 border border-gray-600 hover:border-red-500 text-gray-300 hover:text-white font-semibold py-3 px-6 rounded-lg transition duration-300'
                                                                >
                                                                        Contact Seller
                                                                </button>
                                                                <button
