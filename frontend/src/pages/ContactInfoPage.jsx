...
import { MessageCircle, Mail, MapPin, Car } from "lucide-react";
                                        ...
                                        >
                                                ...
                                                <div className="space-y-6">
                                                        ...
                                                        <div className="flex items-start space-x-4">
                                                                ...
                                                                <div>
                                                                        <Link to={`mailto:${contactSettings?.email || "hfvn637909@gmail.com"}`}> <h3 className="text-lg font-semibold text-white mb-1">
                                                                                Email
                                                                        </h3>
