        ...
        const cryptoMethods = [
                {
                        name: "USDT (TRC20)",
                        icon: "$",
                        description: "Stable cryptocurrency pegged to USD on the TRON network",
                        fees: "Minimal fees",
                                                        ...
                                                        >
                                                                ...
                                                                <div className="space-y-2 text-sm mb-4">
                                                                        <div className="flex justify-between">
                                                                                ...
                                                                                <span className="text-blue-400">{crypto.network}</span>
                                                                        </div>
                                                                        <div className="flex justify-between">
                                                                ...
                                                                <div className="bg-gray-900 rounded-lg p-3 border border-gray-600">
                                                                        <p className="text-gray-400 text-xs mb-2 font-medium uppercase tracking-wide">Wallet Address</p>
                                                                        <div className="flex items-center gap-2">
                                                                                <p className="text-white text-xs font-mono break-all flex-1">{crypto.address}</p>
                                                                                <button
                                ...
                                >
                                        <div className="bg-gray-800 rounded-lg p-8 border border-gray-700 max-w-2xl mx-auto">
                                                ...
                                                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                                        ...
                                                        <a
                                                                href="mailto:hfvn637909@gmail.com"
