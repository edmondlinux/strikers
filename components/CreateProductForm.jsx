				...
				{isVehicleCategory && (
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
						<div>
							...
							<input type='text' id='brand' value={newProduct.brand}
						...
						<div>
							...
							<input type='text' id='model' value={newProduct.model}
								onChange={(e) => setNewProduct({ ...newProduct, model: e.target.value })}
								className='mt-1 block w-full bg-gray-700 border border-gray-600 rounded-md shadow-sm py-2 px-3 text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500' />
						</div>
						<div>
							<label htmlFor='year' className='block text-sm font-medium text-gray-300'>Year</label>
							<input type='number' id='year' value={newProduct.year}
						...
						<div>
							...
							<input type='text' id='mileage' placeholder="e.g., 15,000 miles" value={newProduct.mileage}
						...
						<div>
							...
							<input type='text' id='engine' placeholder="e.g., V6, V8, 4-cylinder" value={newProduct.engine}
								onChange={(e) => setNewProduct({ ...newProduct, engine: e.target.value })}
								className='mt-1 block w-full bg-gray-700 border border-gray-600 rounded-md shadow-sm py-2 px-3 text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500' />
						</div>
						<div>
							<label htmlFor='seats' className='block text-sm font-medium text-gray-300'>Seats</label>
							<input type='number' id='seats' value={newProduct.seats}
								onChange={(e) => setNewProduct({ ...newProduct, seats: e.target.value })}
								className='mt-1 block w-full bg-gray-700 border border-gray-600 rounded-md shadow-sm py-2 px-3 text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500' />
						</div>
						<div>
							<label htmlFor='transmission' className='block text-sm font-medium text-gray-300'>Transmission</label>
							<select id='transmission' value={newProduct.transmission}
						...
						<div>
							...
							<select id='fuelType' value={newProduct.fuelType}
						...
						<div>
							...
							<select id='condition' value={newProduct.condition}
