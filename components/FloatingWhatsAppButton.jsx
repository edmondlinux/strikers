...
const FloatingWhatsAppButton = () => {
	...
	return (
		<div className="fixed bottom-6 right-24 z-50">
			...
			<AnimatePresence>
				{showTooltip && (
					...
					>
						...
						<div className="text-xs text-gray-300 mt-1">Quick responses guaranteed</div>
			...
			<motion.a
				href={contactSettings?.whatsappLink || "https://wa.me/+1305-589-6665?text=Hello! I'm interested in your services."}
				target="_blank"
