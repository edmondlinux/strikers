	...
	return (
		...
		>
			<div className="absolute inset-0 overflow-hidden">
				...
				<FloatingElement delay={0} className="top-20 left-10 text-red-500 opacity-20">
					<Star size={24} />
				</FloatingElement>
				<FloatingElement delay={2} className="top-40 right-20 text-white opacity-10">
					<Zap size={32} />
				</FloatingElement>
				<FloatingElement delay={4} className="bottom-40 left-20 text-red-400 opacity-15">
					<Shield size={28} />
				</FloatingElement>
				<FloatingElement delay={1} className="bottom-20 right-10 text-white opacity-10">
					<Clock size={20} />
				</FloatingElement>
				...
				<div className="grid lg:grid-cols-2 gap-12 items-center">
					<div className="space-y-8">
						...
						<div className="flex flex-wrap gap-4 opacity-0 animate-[fadeInUp_1s_ease-out_2.5s_forwards]">
							<Link href="/inventory">
								<button className="group bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white px-8 py-4 rounded-xl font-semibold flex items-center space-x-2 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-red-500/25 relative overflow-hidden">
							...
							<Link href="/payment">
								<button className="group border-2 border-red-600 text-red-600 hover:bg-red-600 hover:text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 hover:scale-105 hover:shadow-xl relative overflow-hidden">
